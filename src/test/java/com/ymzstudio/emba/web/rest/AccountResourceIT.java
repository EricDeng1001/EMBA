package com.ymzstudio.emba.web.rest;

import com.ymzstudio.emba.StartUp;
import com.ymzstudio.emba.TestUtil;
...
import com.ymzstudio.emba.repository.AuthorityRepository;
import com.ymzstudio.emba.repository.PersistentTokenRepository;
import com.ymzstudio.emba.repository.UserRepository;
import com.ymzstudio.emba.security.AuthoritiesConstants;
import com.ymzstudio.emba.service.MailService;
import com.ymzstudio.emba.service.UserService;
import com.ymzstudio.emba.service.dto.PasswordChangeDTO;
import com.ymzstudio.emba.service.dto.UserDTO;
import com.ymzstudio.emba.web.rest.errors.ExceptionTranslator;
import com.ymzstudio.emba.web.rest.vm.KeyAndPasswordVM;
import com.ymzstudio.emba.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    public void testRegisterInvalidEmail() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.TRADER));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.TRADER));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.TRADER).get());
    }
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(ApplicationConstants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.TRADER));

...
import com.ymzstudio.emba.repository.search.UserSearchRepository;
...
import com.ymzstudio.emba.web.rest.errors.BadRequestAlertException;
import com.ymzstudio.emba.web.rest.errors.EmailAlreadyUsedException;
import com.ymzstudio.emba.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@RequestBody ManagedUserVM userVM) throws URISyntaxException {
        ...
        if (userVM.getId() != null) {
            ...
            User newUser = userService.createUser(userVM, userVM.getPassword());
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        if (existingUser.isPresent() && (!existingUser.get().getId().equals(userDTO.getId()))) {
            logger.info("id: {}, user: {}", existingUser.get().getId(), existingUser.get());
            throw new EmailAlreadyUsedException();
        }
